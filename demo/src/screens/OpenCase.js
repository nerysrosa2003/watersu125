...
export default class OpenCase extends Component {
    ...
    close_alert = async(index) => {
        ...
        [
            {text: 'Cancel', onPress: null},
            {text: 'OK', onPress: () => this.close_case(index)},
        ],
        { cancelable: true })
    };

    close_case = async(index) => {
        var item = this.state.json_array[index];
                    ...
                    <View key = {index} style = {styles.item_view}>
                        ...
                        </View>
                        {
                            ...
                            <View style = {[styles.right_menu_view, {zIndex: 1000-index}]}>
                                <TouchableOpacity style = {styles.right_menu_item} onPress = {() => this.close_alert(index)}>
