...
export default class CloseCase extends Component {
    ...
    delete_alert = async(index) => {
        ...
        [
            ...
            {text: 'OK', onPress: () => this.delete_case(index)},
        ],
        { cancelable: true })
    };

    delete_case = async(index) => {
    ...
    reopen_alert = async(index) => {
        ...
        [
            {text: 'Cancel', onPress: null},
            {text: 'OK', onPress: () => this.reopen_case(index)},
        ],
        { cancelable: true })
    };

    reopen_case = async(index) => {
        var item = this.state.json_array[index];
                    ...
                    <View key = {index} style = {styles.item_view}>
                        ...
                        </View>
                        {
                            ...
                            <View style = {[styles.right_menu_view, {zIndex: 1000-index}]}>
                                <TouchableOpacity style = {styles.right_menu_item} onPress = {() => this.reopen_alert(index)}>
                                    <Text style = {styles.right_menu_text}>Re-open</Text>
                                </TouchableOpacity>
                                <TouchableOpacity style = {styles.right_menu_item} onPress = {() => this.delete_alert(index)}>
